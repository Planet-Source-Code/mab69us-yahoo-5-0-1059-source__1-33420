...
'    ∫ ∫
'    ∫                             -=CRACKS BY MAB=-                            ∫
'    »ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ-=The best crack house on the net=-ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕº
'
'   Yahoe full source
'   By  MAb69us
'
'           In This Source I Will Try To Teace You How To Make Your Own Yahoo Prog
'           so maybe you will learn something  but also Maybe You Wont
'           its all up To You Ok Get You Some thing to drank and use the restroom
'           Then Get Ready
'
'   Ok
'
'    Under Me Are The Public Declare Function                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 This Bas File Was Made By mab69us
'    I'm Not Gonna Tell You Much About Them Now
'    But I Will Tell you What Thay Do In Each Sub
'    That Use's Them
'    Ok Now Go Down To Line 113 the anti boot sub
Public Declare Function sndPlaySound Lib "winmm.dll" Alias "sndPlaySoundA" (ByVal lpszSoundName As String, ByVal uFlags As Long) As Long
Public Declare Function SendMessage& Lib "User32" Alias "SendMessageA" (ByVal hWnd As Long, ByVal wMsg As Long, ByVal wParam As Long, ByVal lParam As Long)
...
'This Is The Pause
'its used in other procedures of this module
'IT Pause's Whatever Is Being Done For How ever Long You Want
'Call It Like This Example
' Call Pause 0.1  <- That Will Pause It For 1 milla sec Get The Point
Sub Pause(interval)
Dim Current
Current = Timer
...
'INfo Like This
'                 {}______/-=(CrƒcKz ﬂy Maﬂ PreSEntS=-\______{}
...
'   Call Loadtext2
Sub Loadtext2()
YahooSend "<B><font size=9><font face = " & Chr(34) & "Arial" & Chr(34) & "><snd=knock>" & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & "CrAcKz By maB RuLez BiTch We Are The BesT CrAcK HouSe On Da Net" & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & "<b><fade #0000FF,#FF0000>{}______/-=(CrƒcKz ﬂy Maﬂ PreSEntS=-\______{}" & vbLf & "<b><fade #FF0000,#0000FF>{}____ (Learn How to Make YOur Own Prog)___{}" & vbLf & "<b><fade #0000FF,#FF0000>{}_(Loaded)_If You Wanna Learn To Then Go To:{}" & vbLf & "<b><fade #FF0000,#0000FF>{}_____-=(Get It At Http://Hacked.at/C-B-M )=-___{}" & vbLf & "Loaded At -> " & Now & ":)"
End Sub
'ends
...
'This Is the PmSend I Use For Boots
'Call It Like This
'  Call SendPM("TEXT1.text")
...
' Call ClearChat
Sub clearchat()
YahooSend vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & "CHAT CLEAR": Pause 0.4: YahooSend vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & vbLf & "CHAT CLEAR": Pause 0.4
End Sub
'end's
...
'This Calls The API Beep Like IN Yahoe 1 When It starts Up
'Call It Like This TO Use IT
' Call Beepapi("100","3000")
Sub Beepapi(Beep As String, frk As String)
Dim frequency As Long
      frequency = CLng(Beep$)
    APIBeep frequency, (frk$)
End Sub
'ends
...
Call Beepapi(800, 20)
Call Beepapi(900, 20)
Call Beepapi(1000, 20)
Call Beepapi(2000, 20)
Call Beepapi(3000, 20)
Call Beepapi(4000, 20)
Call Beepapi(5000, 20)
Call Beepapi(6000, 20)
Call Beepapi(7000, 20)
Call Beepapi(8000, 20)
Call Beepapi(9000, 20)
End Sub
Sub UnloadBeep()
Call Beepapi(9000, 10)
Call Beepapi(9000, 10)
Call Beepapi(8000, 10)
Call Beepapi(8000, 10)
Call Beepapi(7000, 10)
Call Beepapi(7000, 10)
Call Beepapi(6000, 10)
Call Beepapi(6000, 10)
Call Beepapi(5000, 10)
Call Beepapi(5000, 10)
Call Beepapi(4000, 10)
Call Beepapi(4000, 10)
Call Beepapi(3000, 10)
Call Beepapi(3000, 10)
Call Beepapi(2000, 10)
Call Beepapi(2000, 10)
Call Beepapi(1000, 10)
Call Beepapi(1000, 10)
Call Beepapi(900, 10)
Call Beepapi(900, 10)
Call Beepapi(800, 10)
